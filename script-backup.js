...
function calculateFinalScore() {
    ...
    if (jumlahSoal > 0) {
        ...
        document.getElementById('nilai-ujian-sementara').innerText = nilaiUjian;
    } else {
    ...
    const nilaiAkhir = Math.round((nilaiUjian * persentaseNilaiUjian / 100) + (nilaiAkumulasi * persentaseNilaiTutorial / 100));
